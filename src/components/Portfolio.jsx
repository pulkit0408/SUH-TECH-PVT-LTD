...
const PortfolioSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Cross-platform mobile app with workout tracking, nutrition planning, and social features.",
      image:
    ...
    },
    {
      ...
      description:
        "Comprehensive SEO strategy and digital marketing campaign for renewable energy company.",
      image:
    ...
    },
    {
      ...
      client: "StartupXYZ",
      description:
        "Scalable cloud architecture with auto-scaling, monitoring, and CI/CD pipeline implementation.",
      image:
    ...
    },
    {
      ...
      description:
        "Complete restaurant management solution with POS, inventory, and customer relationship features.",
      image:
    ...
    },
    {
      ...
      description:
        "Educational mobile app with video streaming, quiz system, and progress tracking.",
      image:
    ...
    },
    {
      ...
      description:
        "Local search optimization and Google My Business management for healthcare provider.",
      image:
    ...
    },
    {
      ...
      client: "FinTech Pro",
      description:
        "Migration from monolithic to microservices architecture with enhanced security and scalability.",
      image:
    ...
    },
    {
      ...
      description:
        "Modern, responsive website redesign with improved UX and conversion optimization.",
      image:
        "https://images.unsplash.com/photo-1486312338219-ce68e2c6f44d?w=800&h=600&fit=crop",
  ...
  const categories = [
    ...
    },
    {
      key: "app",
      label: "Mobile Apps",
      count: projects.filter((p) => p.category === "app").length,
    },
    {
      key: "seo",
      label: "SEO & Marketing",
      count: projects.filter((p) => p.category === "seo").length,
    },
    {
      key: "cloud",
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16 sm:mb-20">
          ...
          <p className="font-poppins text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            our expertise across web development, mobile applications, SEO, and
            cloud solutions.
          </p>
        </div>
            ...
            >
              ...
              <div
                className={`absolute -inset-1 bg-gradient-to-r ${getCategoryGradient(
                  project.category
                )} rounded-2xl blur-sm opacity-0 group-hover:opacity-60 transition-opacity duration-500`}
              ></div>
              ...
              <div className="relative bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden transform transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                ...
                <div className="relative h-48 sm:h-56 overflow-hidden">
                  ...
                  {/* Category Icon */}
                  <div
                    className={`absolute bottom-4 left-4 w-12 h-12 rounded-xl bg-gradient-to-r ${getCategoryGradient(
                      project.category
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                    ...
                    <div>
                      ...
                      <p
                        className={`font-semibold text-sm bg-gradient-to-r ${getCategoryGradient(
                          project.category
                  ...
                  {/* View Project Button */}
                  <a
                    href="https://suhtech.shop"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full mt-4 px-4 py-3 bg-gradient-to-r from-white/10 to-white/5 border border-white/20 text-white font-medium text-sm rounded-xl hover:bg-white/20 hover:border-white/30 transition-all duration-300 backdrop-blur-sm group-hover:shadow-lg block text-center"
                  >
