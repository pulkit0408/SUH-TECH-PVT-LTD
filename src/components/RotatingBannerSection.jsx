...
const RotatingBannerSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-black min-h-[650px] flex items-center">
      {/* Background Images */}
        ...
        {banners.map((banner, index) => (
          <img
            ...
            className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-1000 ${
              index === currentBanner ? "opacity-20" : "opacity-0"
            }`}
          />
        ))}
      ...
      <div className="relative z-10 w-full text-center px-6">
        <div key={currentBanner} className="animate-fadeSlide">
          <h1
          ...
          <div
            className="inline-block backdrop-blur-md px-8 py-4 rounded-full font-semibold text-lg border border-white/20"
            style={{
